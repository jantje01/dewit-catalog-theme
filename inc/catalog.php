	...
	foreach ( $children as $child ) {
		...
		<li class="<?php echo ( ! is_wp_error( $grandchildren ) && ! empty( $grandchildren ) ) ? 'has-children' : ''; ?>">
			...
			<?php if ( ! is_wp_error( $grandchildren ) && ! empty( $grandchildren ) ) : ?>
				...
				<button class="dewit-category-bar__child-back" type="button"><span class="dewit-category-bar__back-arrow" aria-hidden="true">‹</span><span class="dewit-category-bar__back-label"><?php echo esc_html( $child->name ); ?></span></button>
				<ul>
